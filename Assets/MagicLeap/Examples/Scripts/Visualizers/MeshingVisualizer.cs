...
namespace MagicLeap
{
    ...
    public class MeshingVisualizer : MonoBehaviour
    {
        ...
        void Start()
        {
            _spatialMapper.MLSpatialMapper.fragmentAdded += HandleOnFragmentReady;
            _spatialMapper.MLSpatialMapper.fragmentUpdated += HandleOnFragmentReady;
        }
        ...
        public void SetRenderers(RenderMode mode)
        {
            ...
            foreach (MeshRenderer fragment in _meshRenderers.Values)
            {
                UpdateRenderer(fragment);
            }
        }
        #endregion
        ...
        {
            MeshRenderer meshRenderer = _spatialMapper.MLSpatialMapper.fragmentIdToGameObjectMap[fragmentId].GetComponent<MeshRenderer>();

            // Append the unique MeshRenderer to the dictonary and update the material on that instance.
            if (!_meshRenderers.ContainsKey(fragmentId))
            {
        ...
        /// Clear all fragments.
        /// </summary>
        public void HandleClearFragments()
        {
