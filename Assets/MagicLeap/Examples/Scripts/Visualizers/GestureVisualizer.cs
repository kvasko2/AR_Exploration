...
{
    /// <summary>
    /// Class for tracking a specific gesture and handling confidence value
    ...
    public class GestureVisualizer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Update color of sprite renderer material based on confidence of the gesture.
        /// </summary>
        void Update()
        {
            ...
            float confidenceLeft = _trackLeftHand ? GetGestureConfidence(MLHands.Left) : 0.0f;
            float confidenceRight = _trackRightHand ? GetGestureConfidence(MLHands.Right) : 0.0f;
