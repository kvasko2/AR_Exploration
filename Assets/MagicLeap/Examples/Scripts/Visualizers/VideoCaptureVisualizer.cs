...
namespace MagicLeap
{
    ...
    public class VideoCaptureVisualizer : MonoBehaviour
    {
        ...
        public void OnCaptureStarted()
        {
            ...
            if(_previewText != null)
            {
                _previewText.text = "Press the bumper on control or move button on MLMA to stop capturing a video.";
            }
        ...
        public void OnCaptureEnded(string path)
        {
            ...
            if(_previewText != null)
            {
                _previewText.text = "Press the bumper on control or move button on MLMA to start capturing a video.";
            }
